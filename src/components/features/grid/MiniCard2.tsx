...
export const MiniCard2 = () => {
  return (
    <div className="col-span-2 h-[415px] sm:h-[375px] md:col-span-1">
      <Card>
        <CalloutChip>Deploy</CalloutChip>
        <p className="mb-1.5 text-2xl">Publish without a Mac</p>
        <p className="text-zinc-400">
          Applash pushes your build straight to TestFlight through GitHub and
          Codemagic—no Apple hardware required.
        </p>
        ...
        <div className="absolute -bottom-2 left-2 right-2 z-10 h-44 rounded-xl border border-zinc-700 bg-zinc-800/50 p-4">
          ...
          <p>
            <span className="font-semibold text-blue-300">@applash</span>
            just shipped our iOS app to TestFlight—and we don’t even own a
            Mac!
          </p>
